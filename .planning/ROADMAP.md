...
- [ ] **Phase 1: Critical Fixes** — correctness, data-integrity, and high-severity security blockers
- [ ] **Phase 2: Quality Fixes** — retrieval quality, injection/XSS, cleanup, docs; then rebuild
...
| 2. Quality Fixes | 0/TBD | Not started | - |
